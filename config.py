...
API_ID = 26042091
API_HASH = "73378f07f0922f102cb669a867550b92"
CMD_HNDLR = getenv("CMD_HNDLR", default=".")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
HEROKU_API_KEY = getenv("HEROKU_API_KEY", "57efda49-b3e7-4127-8edb-3aad1d12becd")
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="5456142806").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="6753014811"))
